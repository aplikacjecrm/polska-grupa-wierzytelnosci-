...
async function exportPresentationToPDF() {
    ...
    try {
        ...
        // Ustawienia strony dla prezentacji (16:9 landscape w wysokiej rozdzielczości)
        ...
        for (let i = 0; i < totalSlides; i++) {
            ...
            // Zapisz ten slajd jako osobny PDF
        ...
        // Zapisz scalony PDF
        const finalPdfPath = path.join(outputDir, 'Prezentacja-Federacja-AiT-PKP.pdf');
