    ...
    setupSocketListeners() {
        ...
        socketManager.on('new-chat-message', async (message) => {
            ...
            console.log('🔍 Sprawdzam:', {
                ...
                nadawca: message.sender_id,
                odbiorca: message.receiver_id
            });
            ...
            if (this.currentUser && myUserId) {
                const isIncomingFromCurrentChat = 
                    message.sender_id === this.currentUser.id && message.receiver_id === myUserId;
                const isOutgoingToCurrentChat = 
                    message.sender_id === myUserId && message.receiver_id === this.currentUser.id;
