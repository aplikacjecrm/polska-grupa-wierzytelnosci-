class AuthManager {
    ...
    showMainScreen(isNewLogin = true) {
        ...
        const loadData = () => {
            ...
            // HR i Finance NIE MAJĄ dostępu do CRM - nie ładuj klientów/spraw
            if (userRole !== 'hr' && userRole !== 'finance') {
                ...
                console.log('🚫 Role HR/Finance - pomijam ładowanie CRM (klienci/sprawy)');
            }
