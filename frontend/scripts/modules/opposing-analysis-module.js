...
// Guided Workflow + Smart Buttons + Evidence Bank + AI
// v1.0 - 2025-11-09
// ==========================================

console.log('🕵️ Opposing Analysis Module v1.0 - Guided Workflow MVP');
                    ...
                    <div style="margin-bottom: 25px;">
                        ...
                        <div style="display: flex; gap: 15px;">
                            <label style="flex: 1; cursor: pointer;">
                                ...
                                <span style="font-size: 1.1rem; color: #000000 !important; font-weight: 700;">🏢 Firma</span>
                            </label>
                            <label style="flex: 1; cursor: pointer;">
                                <input type="radio" name="party_type" value="individual" style="margin-right: 8px;" />
                                <span style="font-size: 1.1rem; color: #000000 !important; font-weight: 700;">👤 Osoba fizyczna</span>
                            </label>
                        </div>
                    </div>
            ...
            <div>
                ...
                ${data.party_type === 'company' ? `
                    <div style="background: #F8FAFC; padding: 20px; border-radius: 8px; margin-bottom: 30px;">
                        <h4 style="margin: 0 0 15px 0; color: #1E40AF;">🔍 Sprawdź w rejestrach:</h4>
                        <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                            <button onclick="window.opposingAnalysisModule.searchInKRS()" style="padding: 10px 20px; background: linear-gradient(135deg, #1E40AF 0%, #1565c0 100%); color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: 600; box-shadow: 0 2px 8px rgba(25,118,210,0.3);">
                                🏛️ Wyszukiwarka KRS
                            </button>
                            <button onclick="window.opposingAnalysisModule.searchInCEIDG()" style="padding: 10px 20px; background: white; border: 2px solid #1E40AF; color: #1E40AF; border-radius: 8px; cursor: pointer; font-weight: 600;">
                                📋 CEIDG
                            </button>
                            <button onclick="window.opposingAnalysisModule.searchInGoogle()" style="padding: 10px 20px; background: white; border: 2px solid #1E40AF; color: #1E40AF; border-radius: 8px; cursor: pointer; font-weight: 600;">
                                🌐 Google
                            </button>
                        </div>
                        <p style="margin: 15px 0 0 0; font-size: 0.9rem; color: #1E40AF;">
                            💡 <strong>Wyszukiwarka KRS</strong> - automatycznie wyszukuje firmę po nazwie w oficjalnym rejestrze MS
                        </p>
                    </div>
                ` : ''}
                ...
                <div style="display: grid; gap: 25px;">
                    ...
                    <div>
                        ...
                        <div style="display: grid; gap: 10px;">
                            <label style="display: block; color: #000000; font-weight: 600;"><input type="checkbox" id="tactic_delays" ${data.tactic_delays ? 'checked' : ''} style="margin-right: 8px;" />Opóźnianie postępowania</label>
                            <label style="display: block; color: #000000; font-weight: 600;"><input type="checkbox" id="tactic_motions" ${data.tactic_motions ? 'checked' : ''} style="margin-right: 8px;" />Liczne wnioski formalne</label>
                            <label style="display: block; color: #000000; font-weight: 600;"><input type="checkbox" id="tactic_settlement" ${data.tactic_settlement ? 'checked' : ''} style="margin-right: 8px;" />Unikanie ugody</label>
                            <label style="display: block; color: #000000; font-weight: 600;"><input type="checkbox" id="tactic_witnesses" ${data.tactic_witnesses ? 'checked' : ''} style="margin-right: 8px;" />Agresywne przesłuchania</label>
                            <label style="display: block; color: #000000; font-weight: 600;"><input type="checkbox" id="tactic_evidence" ${data.tactic_evidence ? 'checked' : ''} style="margin-right: 8px;" />Kwestionowanie dowodów</label>
                        </div>
                    </div>
...
console.log('✅ Opposing Analysis Module loaded');
