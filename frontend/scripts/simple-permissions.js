...
window.showPermissionsSimple = async function(caseId) {
    ...
    try {
        ...
        const response = await fetch(`http://localhost:3500/api/case-permissions/${caseId}/list`, {
...
window.submitGrantAccess = async function(caseId) {
    ...
    try {
        ...
        const endpoint = accessType === 'temporary' 
            ? `http://localhost:3500/api/case-permissions/${caseId}/grant-temporary`
            : `http://localhost:3500/api/case-permissions/${caseId}/grant-permanent`;
